...
$(function animatedTotalProgress() {
  if ($("#competenceProgressBarPage").length > 0){
    ...
    $("#goalBar").css("width", current_progress + "%");
    $("#goalBarWrong").css("width", current_progress_wrong + "%");
    $("#goalText")
...
$(function animatedDailyProgress() {
  if ($("#competenceProgressBarPage").length > 0){
    ...
    var interval = setTimeout(function() {
      ...
      $("#achievementBar").css("width", daily_progress + "%");
      $("#achievementBarWrong").css("width", daily_progress_wrong + "%");
      $("#achievementText")
